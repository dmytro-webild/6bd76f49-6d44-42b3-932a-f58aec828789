        ...
        >
          <div className="p-6 rounded-lg border border-foreground/10 bg-card">
            ...
            <div className="grid grid-cols-2 gap-2">
              <img src="http://img.b2bpic.net/free-photo/ancient-vaults-cathedral-windows-stone-architecture-with-history-sacred-church-atmosphere_169016-68741.jpg?_wi=3" alt="Heritage museum exterior architecture with cultural design elements" className="w-full h-24 object-cover rounded" />
              <img src="http://img.b2bpic.net/free-photo/hallway-abbey_181624-16761.jpg?_wi=1" alt="Heritage museum interior gallery space showcasing cultural artifacts" className="w-full h-24 object-cover rounded" />
            </div>
          </div>
          ...
          <div className="p-6 rounded-lg border border-foreground/10 bg-card">
            ...
            <div className="grid grid-cols-2 gap-2">
              <img src="http://img.b2bpic.net/free-photo/hallway-abbey_181624-16761.jpg?_wi=2" alt="Community center gathering space designed for cultural events and celebrations" className="w-full h-24 object-cover rounded" />
              <img src="http://img.b2bpic.net/free-photo/frog-s-eye-view-architectural-twin-buildings-against-clear-blue-sky_181624-59777.jpg?_wi=3" alt="Community center exterior showing contemporary cultural architecture" className="w-full h-24 object-cover rounded" />
            </div>
          </div>
          ...
          <div className="p-6 rounded-lg border border-foreground/10 bg-card">
            ...
            <div className="grid grid-cols-2 gap-2">
              <img src="http://img.b2bpic.net/free-photo/frog-s-eye-view-architectural-twin-buildings-against-clear-blue-sky_181624-59777.jpg?_wi=1" alt="Residential complex showcasing heritage-inspired architectural design" className="w-full h-24 object-cover rounded" />
              <img src="http://img.b2bpic.net/free-photo/vertical-low-angle-shot-laktha-center-reflecting-sunset-russia_181624-30555.jpg?_wi=2" alt="Residential complex sunset view reflecting cultural pride and design excellence" className="w-full h-24 object-cover rounded" />
            </div>
          </div>
          ...
          <div className="p-6 rounded-lg border border-foreground/10 bg-card">
            ...
            <div className="grid grid-cols-2 gap-2">
              <img src="http://img.b2bpic.net/free-photo/gothic-vaults-stone-ceiling-patterns-historic-church-architecture_169016-68764.jpg?_wi=1" alt="Synagogue interior architectural details preserving historic religious heritage" className="w-full h-24 object-cover rounded" />
              <img src="http://img.b2bpic.net/free-photo/ancient-vaults-cathedral-windows-stone-architecture-with-history-sacred-church-atmosphere_169016-68741.jpg?_wi=1" alt="Synagogue restoration exterior maintaining cultural and historical significance" className="w-full h-24 object-cover rounded" />
            </div>
          </div>
        </CardStack>
      </div>
