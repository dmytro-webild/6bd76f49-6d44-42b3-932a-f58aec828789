          ...
          items={[
            {
              ...
              media: (
                <div className="grid grid-cols-2 gap-2 w-full h-full">
                  <img src="http://img.b2bpic.net/free-photo/ancient-vaults-cathedral-windows-stone-architecture-with-history-sacred-church-atmosphere_169016-68741.jpg?_wi=1" alt="Heritage museum exterior" className="w-full h-full object-cover rounded" />
                  <img src="http://img.b2bpic.net/free-photo/hallway-abbey_181624-16761.jpg?_wi=1" alt="Heritage museum interior gallery" className="w-full h-full object-cover rounded" />
                </div>
              )
            },
            {
              ...
              media: (
                <div className="grid grid-cols-2 gap-2 w-full h-full">
                  <img src="http://img.b2bpic.net/free-photo/hallway-abbey_181624-16761.jpg?_wi=2" alt="Community center gathering space" className="w-full h-full object-cover rounded" />
                  <img src="http://img.b2bpic.net/free-photo/frog-s-eye-view-architectural-twin-buildings-against-clear-blue-sky_181624-59777.jpg?_wi=1" alt="Community center exterior architecture" className="w-full h-full object-cover rounded" />
                </div>
              )
            },
            {
              ...
              media: (
                <div className="grid grid-cols-2 gap-2 w-full h-full">
                  <img src="http://img.b2bpic.net/free-photo/frog-s-eye-view-architectural-twin-buildings-against-clear-blue-sky_181624-59777.jpg?_wi=1" alt="Residential complex architectural design" className="w-full h-full object-cover rounded" />
                  <img src="http://img.b2bpic.net/free-photo/vertical-low-angle-shot-laktha-center-reflecting-sunset-russia_181624-30555.jpg?_wi=2" alt="Residential complex sunset view" className="w-full h-full object-cover rounded" />
                </div>
              )
            },
            {
              ...
              media: (
                <div className="grid grid-cols-2 gap-2 w-full h-full">
                  <img src="http://img.b2bpic.net/free-photo/gothic-vaults-stone-ceiling-patterns-historic-church-architecture_169016-68764.jpg?_wi=1" alt="Synagogue interior architectural details" className="w-full h-full object-cover rounded" />
                  <img src="http://img.b2bpic.net/free-photo/ancient-vaults-cathedral-windows-stone-architecture-with-history-sacred-church-atmosphere_169016-68741.jpg?_wi=1" alt="Synagogue restoration exterior" className="w-full h-full object-cover rounded" />
                </div>
              )
            }
          ]}
